...
var (
	...
	// Program
	BuildProgram        func(program Program, numDevices uint32, devices []Device, options string, pfnNotify *BuildProgramNotifyFuncType, userData []byte) Status = nil
	...
	// Kernel
	SetKernelArg  func(kernel Kernel, argIndex uint, argSize Size, argValue unsafe.Pointer) Status = nil
